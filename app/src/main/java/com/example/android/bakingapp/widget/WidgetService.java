        ...
        public RemoteViews getViewAt(int position) {
            ...
            if (mCursor.getCount() != 0) {
                ...
                remoteViews.setTextViewText(R.id.widget_ingredient_name,
                        mCursor.getString(mCursor.getColumnIndex(Contract.Entry.COLUMN_NAME_INGREDIENTS)));
                String measure =
                        mCursor.getString(mCursor.getColumnIndex(Contract.Entry.COLUMN_NAME_QUANTITY))
                                + " " +
                                mCursor.getString(mCursor.getColumnIndex(Contract.Entry.COLUMN_NAME_MEASURE));
