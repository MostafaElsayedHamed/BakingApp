...
public class Helper extends SQLiteOpenHelper {
    ...
    private static final String SQL_CREATE_ENTRIES =
            "CREATE TABLE " + Contract.Entry.TABLE_NAME + " (" +
                    Contract.Entry._ID + INTEGER + PRIMARY_KEY_AUTO_INCREMENT +
                    Contract.Entry.COLUMN_NAME_QUANTITY + INTEGER +
                    Contract.Entry.COLUMN_NAME_INGREDIENTS + TEXT +
                    Contract.Entry.COLUMN_NAME_MEASURE + TEXT_NO_COMMA +
                    " );";

    private static final String DROP_TABLE_QUERY =
            " DROP TABLE " + Contract.Entry.TABLE_NAME + ";";
